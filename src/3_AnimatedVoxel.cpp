...
int main() {
	...
	voxelArloImage.createSampler(true);
	...
	voxelNoiseImage.createSampler(true);
	...
	ComputeShaderModule voxelGenerationShader(root+"/shaders/9_miscellaneous/voxelVisible.comp.spv");
...
//	FragmentShaderModule fragmentShaderEmpty(root+"/shaders/optrta/interval_EMPTY.frag.spv");
	...
	FragmentShaderModule fragmentShader(root+"/shaders/3_fragment/voxelVisible.frag.spv");
